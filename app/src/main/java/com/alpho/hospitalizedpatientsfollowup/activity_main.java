...
/*
 * TodosOverviewActivity displays the existing patient treatment and prescription
 * in a list
 *
 * You can create new ones via the ActionBar entry "Insert"
 * You can delete existing ones via a long press on the item
 */
public class activity_main extends ListActivity implements
...
// Fields on the UI to which we map
        ...
        adapter = new SimpleCursorAdapter(this, R.layout.activity_patient_row, null, from,
                to, 0);
